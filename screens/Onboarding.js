...
export default function Onboarding() {
    ...
    return(
        <View style={styles.container}>
            <Text style={styles.title}>Welcome to ExGro</Text>
            <View style={styles.featureContainer}>
                <Image style={styles.icon} source={require('../assets/arrows.png')} />
                <View style={{flex: 1}}>
                    <Text style={styles.subTitle}>Track all the groceries</Text>
                    <Text style={styles.subHeadline}>ExGro is a simple app that helps you to remind about groceries</Text>
                </View>
            </View>
            <View style={styles.featureContainer}>
                ...
                <View style={{flex: 1}}>
                    ...
                    <Text style={styles.subHeadline}>Get notified when groceries are about to expire.</Text>
                </View>
            </View>
            <View style={styles.featureContainer}>
