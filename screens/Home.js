    ...
    return (
        ...
        <ScrollView style={styles.container}>
            ...
            { todayTodos.length > 0  
              ...
              : <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', marginBottom: 20}}>
                  <Image
                    source={require('../assets/todayPhoto-removebg-preview.png')}
                    style={{width: 180, height: 180, marginBottom: 5, resizeMode: 'contain', marginLeft: 10}}
                  />
                  <Text style={{fontSize: 13, color: SetTheme.lightTheme.textColor, fontWeight: 'bold'}}>CONGRATS!</Text>
        ...
        : <View style={styles.container}>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center', flex: 1}}>
                <Image
                    source={require('../assets/emptyList-removebg-preview.png')}
                    style={{width: 200, height: 200, marginBottom: 0, resizeMode: 'contain'}}
                />
                <Text style={{fontSize: 13, color: SetTheme.lightTheme.textColor, fontWeight: 'bold'}}>NICE!</Text>
                <Text style={{fontSize: 13, color: SetTheme.lightTheme.textColor, fontWeight: '500'}}>Nothing is scheduled.</Text> 
            </View>
